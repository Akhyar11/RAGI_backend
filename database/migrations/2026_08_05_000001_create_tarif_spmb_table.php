    ...
    public function up(): void
    {
        if (!Schema::hasTable('sikeu_tarif_spmb')) {
            Schema::create('sikeu_tarif_spmb', function (Blueprint $table) {
                $table->id();
                $table->foreignId('master_biaya_id')->nullable()->constrained('sikeu_master_biaya')->onDelete('cascade');
                ...
                $table->unique(['master_biaya_id', 'jalur_id', 'gelombang_id'], 'tarif_spmb_unique');
            });
        }
    }
